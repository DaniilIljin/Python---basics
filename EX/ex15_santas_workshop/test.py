...
#     s = santas_workshop.Santas_factory('test_wish_list.csv', 'test_nice_list.csv', 'test_naughty_list.csv')
#     assert s.recieve_info_from_file('test_nice_list.csv') == [['Tanya', ' United Kingdom'], ['Jamie', ' Canada'], ['Chelsea', ' South Africa'],
